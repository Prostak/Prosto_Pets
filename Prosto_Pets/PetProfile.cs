// Based on AutoAngler's Profile code
using System;
...
namespace Prosto_Pets
{
	class PetProfile
	{
		...
		public void LoadWayPoints()
		{
            ...
            if (HBProfile == null) what += "HBprofile";
            else if (HBProfile.GrindArea == null) what += "GrindArea";
            else if (HBProfile.GrindArea.Hotspots == null) what += "Hotspots";
            what += " empty";
